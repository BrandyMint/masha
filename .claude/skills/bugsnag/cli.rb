...
class BugsnagCLI
  ...
  def show_help
    <<~HELP
      ...
      **Использование:**
      `skill: "bugsnag-lookuper" "<команда> [аргументы]"`
      ...
      **Примеры использования:**
      ...
      skill: "bugsnag-lookuper" "детали ошибки 5f8a9b2c"
      skill: "bugsnag-lookuper" "отметь ошибку 5f8a9b2c как выполненную"
      skill: "bugsnag-lookuper" "проанализируй текущие ошибки"
      ```
