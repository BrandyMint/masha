    ...
    context 'with valid inputs' do
      context 'standard format: hours project description' do
        it 'parses correctly' do
          ...
          expect(result[:message]).to include '✅ Отметили 2.5ч в проекте project1'
        end
      end
      ...
      context 'reverse format: project hours description' do
        it 'parses correctly' do
          ...
          expect(result[:success]).to be true
          expect(result[:message]).to include '✅ Отметили 1.5ч в проекте project2'
        end
      end
      ...
      context 'project with digits' do
        it 'handles project123 2.5 format' do
          ...
          expect(result[:success]).to be true
          expect(result[:message]).to include '✅ Отметили 2.5ч в проекте project123'
        end
      ...
      context 'with decimal comma' do
        it 'handles comma as decimal separator' do
          ...
          expect(result[:success]).to be true
          expect(result[:message]).to include '✅ Отметили 1.5ч в проекте project1'
        end
      end
    end
  ...
  describe '#add_time_entry' do
    ...
    context 'with normal hours' do
      it 'creates time entry successfully' do
        ...
        expect(result).to include('✅ Отметили 2.5ч в проекте project1')
    ...
    context 'with many hours' do
      it 'shows warning' do
        ...
        expect(result).to include('✅ Отметили 15.0ч в проекте project1')
    ...
    context 'with few hours' do
      it 'shows info' do
        ...
        expect(result).to include('✅ Отметили 0.25ч в проекте project1')
