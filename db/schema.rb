...
ActiveRecord::Schema.define(version: 20141203100501) do
  ...
  add_index "invites", ["email", "project_id"], name: "index_invites_on_email_and_project_id", unique: true, using: :btree
